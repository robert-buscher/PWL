...
- **RichVocab**: assigns a richness score to the vocabulary used in each article and the folders as a whole. Then compares the articles provided based on the richness of their vocabulary.
- **RepeatWords**: breaks down the folder into the separate articles and then compares the words from those articles, creating a list of the top ten most repeated words.
